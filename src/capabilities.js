...
const capabilities = [
  ...
  { group: 'feed', route: '/radio/list', methods: ['GET', 'POST'], auth: false, app_context: true, raw: true, description: '电台列表（上游需登录态，当前返回空）' },
  { group: 'feed', route: '/radio/tracks', methods: ['GET', 'POST'], auth: false, app_context: true, raw: true, description: '电台歌曲 Feed（上游需登录态）' },
